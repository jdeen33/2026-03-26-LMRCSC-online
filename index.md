...
venue: "Living Marine Resources Cooperative Science Center"        # brief name of the institution that hosts the workshop without address (e.g., "Euphoric State University")
...
humandate: "March 26-28, 2026"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "10:00 am - 6:00 PM EST"    # human-readable times for the workshop e.g., "9:00 am - 4:30 pm CEST (7:00 am - 2:30 pm UTC)"
startdate: 2026-03-26     # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate: 2026-03-28       # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Elizabeth Stregger", "Richard Gayle", "Caitlin Bakker", "Julia Deen", ] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Gabriel Leiva-Gomez","Jahlen Pinelo","Carlos Ramirez-Reyes", ]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["estregger@mta.ca","rcgayle@protonmail.com", "caitlin.bakker@uregina.ca", "jdeen@middlebury.edu", "cramirezreyes@unr.edu", "masexton@umes.edu"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
